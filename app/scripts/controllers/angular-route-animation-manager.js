angular.module('mziolekplApp')
    .run(['$rootScope', 'RouteAnimationManager', function($rootScope, RouteAnimationManager) {
...
angular.module('mziolekplApp')
    .provider('RouteAnimationManager', function()  {
    ...
    function RouteAnimationManager() {
        this.setAnimationClass =  function(currentRoute, nextRoute) {
            ...
            var name = currentRoute.originalPath.substring(1) || 'main'; //root refers to the '/' route
...
angular.module('mziolekplApp')
    .directive('routeAnimationManager', function() {
    return {
        restrict: 'AE',
        transclude: true,
        replace: true,
